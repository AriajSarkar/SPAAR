 ...
 */
export const LoginRequired = ({ message = 'You need to log in to access this feature.' }: LoginRequiredProps) => {
    return (
        <Card className="p-6 bg-card shadow-md border border-gray-800 max-w-md w-full">
            <div className="flex flex-col items-center text-center space-y-4">
                <div className="w-12 h-12 rounded-full bg-blue-600/20 flex items-center justify-center">
                    <svg
                        className="w-6 h-6 text-[color:var(--heart-blue-500)]"
                        viewBox="0 0 24 24"
                        fill="none"
                ...
                <p className="text-sm text-gray-400">Please log in to your account to continue using this feature.</p>
