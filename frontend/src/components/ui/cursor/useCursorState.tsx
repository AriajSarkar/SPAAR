...
export function CursorProvider({ children }: { children: React.ReactNode }) {
    ...
    const contextValue = useMemo(() => ({
        state: {
            get cursorX() { return stateRef.current.cursorX; },
            get cursorY() { return stateRef.current.cursorY; },
            get isHovering() { return stateRef.current.isHovering; },
            get hoveredElementRect() { return stateRef.current.hoveredElementRect; },
            content
        },
        setHovering,
