            ...
            <Card className="w-full max-w-md p-6 bg-card shadow-lg">
                <div className="space-y-6">
                    <div className="text-center">
                        ...
                        <p className="text-sm text-muted-foreground mt-1">Register to start chatting with AI</p>
                    </div>
                    ...
                    <div className="text-center text-sm">
                        ...
                        <Link href="/login" className="text-[color:var(--heart-blue-500)] hover:underline">
                            Log in
                        </Link>
                    </div>
                </div>
